      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center md:flex-row w-full h-full relative z-10">
        ...
        >
          ...
          <div className="relative group">
            ...
            {/* Overlay Glow */}
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-secondary/10 via-transparent to-pry/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          </div>
