...
const HeroSection = () => {
  return (
    <section className="relative z-20 flex flex-col items-center justify-end bg-gradient-to-b from-sec via-sec to-secondary text-gray-700 min-h-[75vh] px-6 md:px-0">
      {/* Grid Overlay */}
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center justify-center md:flex-row w-full h-full">
        <div className="py-10 text-start text-[#fafafa] md:max-w-3xl h-full w-full md:py-0">
          ...
          <h1 className="text-2xl md:text-5xl font-bold font-poppins leading-snug drop-shadow-md mb-4">
            I Help Breathe Life
          ...
          <div className="mt-8">
            <button className="bg-[#fff2e6] text-[#994C12] text-lg font-semibold font-jakarta border border-button px-3 py-2 rounded-full shadow hover:bg-[#f7e0c9] transition-all duration-300 ease-linear cursor-pointer md:py-2.5 md:px-5 md:text-xl">
              Contact Me
            </button>
          </div>
        </div>
